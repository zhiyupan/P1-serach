...
def depthFirstSearch(problem):
    ...
    #print("Start:", problem.getStartState())
    #print("Is the start a goal?", problem.isGoalState(problem.getStartState()))
    return print("Start's successors:", problem.getSuccessors(problem.getStartState()))
    
    # fringe = util.Stack()
    # def add_to_fringe_fn(fringe, stata, cost):
    #     fringe.push(stata)
    ...
    while not fringe.isEmpty():
        ...
        if not node in closed:
            ...
            for child_node, child_action, child_cost in problem.getSuccessors(node):
                ...
                new_stata = (child_node, new_cost, new_path)
                add_to_fringe_fn(fringe, new_stata, new_cost)         
